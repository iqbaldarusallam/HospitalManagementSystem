      ...
      <div class="col-md-6 mx-auto">
        ...
        <table class="table table-bordered table-striped table-hover">
          ...
          if (isset($_POST['bsearch'])) {
            ...
            $sql2 = "SELECT * FROM tbpembayaran WHERE no_pembayaran LIKE '%$keyword%' OR no_pasien LIKE '%$keyword%' OR nama_pasien LIKE '%$keyword%' OR kode_obat LIKE '%$keyword%' OR harga_obat LIKE '%$keyword%' OR jumlah_beli LIKE '%$keyword%' OR total LIKE '%$keyword%' OR tanggal LIKE '%$keyword%'";
        } else {
            $sql2 = "SELECT * FROM tbpembayaran";
        }
              ...
              <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                  <div class="modal-header">
                    <h1 class="modal-title fs-5" id="staticBackdropLabel">FORM DATA PAYMENT</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                            aria-label="Close"></button>
                  </div>

                  <form method="POST" action="../action_crudpembayaran.php">
                    <div class="modal-body">
                      <div class="mb-3">
                        <label class="form-label">No. Pembayaran</label>
                        <input type="text" class="form-control" name="no_pembayaran"
                               value="<?= $data['no_pembayaran'] ?>" readonly>
                      </div>
                      <div class="mb-3">
                  ...
                  <form method="POST" action="../action_crudpembayaran.php">
                    <div class="modal-body">
                      <h5 class="text-center"> Are you sure you want to delete this data? <br>
                        <span
                          class="text-danger"><?= $data['no_pembayaran'] ?> - <?= $data['nama_pasien'] ?></span>
                      </h5>
                      <input type="hidden" name="no_pembayaran" value="<?= $data['no_pembayaran'] ?>">
                    </div>
                    <div class="modal-footer">
              ...
              <form method="POST" action="../action_crudpembayaran.php">
                <div class="modal-body">
                  <div class="mb-3">
                    <label class="form-label">No. Pembayaran</label>
                    <input type="text" class="form-control" name="no_pembayaran"
                           placeholder="Enter your Number Payment!">
                  </div>
                  <div class="mb-3">
                    <label class="form-label">No. Pasien</label>
                    <input type="text" class="form-control" name="no_pasien">
